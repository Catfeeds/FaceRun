...
public class RecordAdapter extends BaseSwipListAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvUseTime.setText(TimeFormatUtils.formatDurationHHMMss(Long.parseLong(bean.getmUseTime())));
        ...
        if (distance > 0) {
            String strSpeed = LocationUtils.caculateSpeed(distance, Long.parseLong(bean.getmUseTime()));
